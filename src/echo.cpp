...
bool Echo::AddEcho_FIR(std::vector<double>& buffer, double gain, double feedback, double time, double sample_rate) {
...
//bool Echo::AddEcho_IIR(std::vector<double>& buffer, double magnitude, double feedback, double time, double sample_rate) {
